...
namespace Ymf825
{
    ...
    public class DataTransferedEventArgs : EventArgs
    {
        ...
        /// <summary>
        /// 送信先または受信元のデバイスを表す <see cref="Ymf825.TargetDevice"/> 列挙体から構成されるフラグ値を取得します。
        /// </summary>
        ...
        /// <inheritdoc />
        /// <summary>
        /// 引数を指定して新しい <see cref="T:Ymf825.DataTransferedEventArgs" /> クラスのインスタンスを初期化します。
        /// </summary>
        /// <param name="targetDevice">送信先または受信元のデバイスを表す <see cref="Ymf825.TargetDevice"/> 列挙体から構成されるフラグ値。</param>
